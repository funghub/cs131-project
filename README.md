...
- The different chromosomes highlighted by effect size plots and the Manhattan plots could mean the differences between ancestry do not need to have the strongest GWAS association.
